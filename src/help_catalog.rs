...
pub fn json_help(lang: &Lang, command: &[String]) -> Value {
    json!({
        ...
        "commands": [
            ...
            "task image|pdf|attachment list --id <task-id>",
            "task image|pdf|attachment add --id <task-id> --file <path> [--dry-run]",
            "task image|pdf|attachment delete --id <task-id> --attachment-id <id> [--dry-run]",
            "project list",
            "project create --input <file|->",
            "project image|pdf|attachment list --id <project-id>",
            "project image|pdf|attachment add --id <project-id> --file <path> [--dry-run]",
            "project image|pdf|attachment delete --id <project-id> --attachment-id <id> [--dry-run]",
            "milestone list",
            "milestone create --input <file|->",
            "milestone image|pdf|attachment list --id <milestone-id>",
            "milestone image|pdf|attachment add --id <milestone-id> --file <path> [--dry-run]",
            "milestone image|pdf|attachment delete --id <milestone-id> --attachment-id <id> [--dry-run]",
